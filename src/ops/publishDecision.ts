/**
 * Organoid Publish Decision — Consolidates pre/post publish checks.
 *
 * Called by pipeline (pre) and worker (post). Does NOT replace existing
 * dedupeGuard, rateLimiter, or launchGate — wraps them for Organoid semantics.
 *
 ...
 * Pipeline already does this inline; this is the consolidated Organoid entry point.
 */
