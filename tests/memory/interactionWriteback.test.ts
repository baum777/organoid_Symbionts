...
describe("Interaction Writeback", () => {
  ...
  it("updates user-embodiment affinity after writeback", async () => {
    const params: InteractionWritebackParams = {
      event_id: "ev_1",
      user_id: "user123",
      user_handle: "testuser",
      selected_embodiment_id: "organoid",
    ...
    const affinity = await store.getAffinity("user123", "organoid");
